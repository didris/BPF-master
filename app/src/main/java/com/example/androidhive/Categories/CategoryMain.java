...
public class CategoryMain extends Activity implements AdapterView.OnItemSelectedListener {
        ...
        private String URL_NEW_CATEGORY = "http://bestpricefinder.eb2a.com/Category/new_category.php";
        // Url to get all categories
        private String URL_CATEGORIES = "http://bestpricefinder.eb2a.com/Category/get_categories.php";
        ...
        private class GetCategories extends AsyncTask<Void, Void, Void> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                pDialog = new ProgressDialog(CategoryMain.this);
        ...
        /**
         * Async task to create a new category
         * */
